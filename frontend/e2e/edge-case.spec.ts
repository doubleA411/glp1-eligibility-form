...
test("edge case - clinical review when blood pressure selects both normal and hypertensive crisis", async ({
  page,
}) => {
  ...
  // Screen 14 - Diet
  await page.getByTestId("checkbox-input-balanced-diet").click();
  await page.getByTestId("next-button").click();
